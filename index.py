...
async def main():
    ...
    nickname = await input("Join the chat", required=True, placeholder="Your name", validate=lambda n: "This nickname is already in use!" if n in online_users or n == '📢' else None)
